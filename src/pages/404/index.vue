<template>
  <div class='hy-404' style="background:#f0f2f5;margin-top: -20px;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">版权所有
          <a class="link-type" href="https://wallstreetcn.com" target='_blank'>国家电网公司</a>
        </div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">请检查您输入的网址是否正确，请点击以下按钮返回主页</div>
        <router-link to="/deviceTreeTemplateHome" class="bullshit__return-home">返回首页
        </router-link>
      </div>
    </div>
  </div>
